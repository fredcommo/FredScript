NormRG.v0.1 <- function(Tum, Ref, Cy = TRUE, GC = TRUE, Centr = TRUE, Fract = 1, span = 0.3,
                        cut = c(-0.5, 0.5), G = 3:7, peakThresh = 0.75, MergePeaks = T, MergeVal = 0.075,
                        method = "Zero", Plot = TRUE, Expand = 1.75, Save = FALSE, Root = "E",...){
