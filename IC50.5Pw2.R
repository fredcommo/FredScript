IC50.5Pw2 <- function(dose, rep, sd, W.coef=0.5, unit="nM", Title="", Plot.sd = TRUE, AddIC = TRUE, Add = FALSE, ptCol="indianred3", lCol="royalblue4"){
...
# Avec nlm
	...
	# initialisation des valeurs
		...
		init <- c(bottom.ini, top.ini, xmid.ini, scal.ini, s.ini, w.coef)
