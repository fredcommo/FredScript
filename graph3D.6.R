graph3D.6<-function(X, class1 = NULL, class2 = NULL, size=2, log.base = 4, bold = TRUE, title=NULL)
...
# Begin
{
	...
	# Define color values
		col.palette<-c("navy", "goldenrod3", "indianred1", "seagreen3", "royalblue1", "purple1", "burlywood2", "firebrick1", "green4", "deeppink1", "deepskyblue2")	# 1 = "black" is excluded	
